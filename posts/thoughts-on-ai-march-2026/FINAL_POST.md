...
I’m sure the researchers at OpenAI will do another round of Twitter finetuning on data from 2026.
Expect AI’s new prose to match that of today’s most popular humans. Em dashes will become a hallmark
of 2025 LLMs. Opus 5 uses semicolons instead; I will change my style to avoid writing like a bot.
The cycles of fashion will accelerate.

Already many humans prefer Claude’s prose so their own, and let LLMs edit or fully write most of
...
the 2026 version of a pinstripe suit and nice business cards. The problem is that these people have
genuinely convinced themselves.
...
If you’re deeply cynical, you might claim that we’re only seeing a trend continue here. Biz dev
departments are obviously doing real work; how else would they have made such professional slides?
HR has large meetings with agendas. Security has clear policies and writes long reports before
allowing new software. Landing pages are making that same transition that slides, meetings, and
written reports have already finished: from a useful tool to a simulacrum of effort and seriousness.
...
These sentences sound just like BuzzFeed headlines circa 2014. OpenAI probably rewarded the models
too much for getting follow-up questions.
...
[^2]:
    I’m sure Jhourney is a serious business and I’m tempted to go on one of their retreats. But this
    landing page was a strong negative signal for me.
